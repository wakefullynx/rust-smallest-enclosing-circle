...
impl Circle {
    pub fn new(points: &Vec<Point>) -> Self {
        match points.len() {
            ...
            3 => Circle::Three(
                ...
                points[1],
                points[2],
                orient2d(points[0], points[1], points[2]) > 0.,
            ),
            _ => {
                panic!()
            }
    ...
    fn surrogate(&self) -> Option<Point> {
        match self {
            Circle::Zero | Circle::One(_) | Circle::Three(_, _, _, _) => None,
            Circle::Two(a, b) => {
...
macro_rules! make_circle {
    ($points: ident) => {{
        match $points.len() {
            ...
            3 => {
                Circle::Three($points[0], $points[1], $points[2], orient2d($points[0], $points[1], $points[2]) > 0.)
            }
            _ => {
                Circle::Zero
            }
...
pub fn smallest_enclosing_circle(points: &Vec<Point>) -> Circle {
    let mut p = points.to_vec();
    let mut r = Vec::new();
    let mut circle = Circle::Zero;
...
pub fn smallest_enclosing_circle_recursive(points: &Vec<Point>) -> Circle {
...
mod tests {
    ...
    mod iterative {
        ...
        #[test]
        fn basic_collinear() {
            let r = smallest_enclosing_circle(&Vec::from([[0., 0.], [1., 0.], [2., 0.]]));
        ...
        #[test]
        fn basic_duplicate() {
            let r = smallest_enclosing_circle(&Vec::from([[0., 0.], [1., 0.], [1., 0.]]));
        ...
        #[test]
        fn basic_duplicate2() {
            let r = smallest_enclosing_circle(&Vec::from([[1., 0.], [0., 0.], [1., 0.]]));
        ...
        #[test]
        fn basic_single() {
            let r = smallest_enclosing_circle(&Vec::from([[0., 0.]]));
        ...
        #[test]
        fn basic_double() {
            let r = smallest_enclosing_circle(&Vec::from([[0., 0.], [1., 0.]]));
        ...
        fn basic_double_duplicate() {
            let r = smallest_enclosing_circle(&Vec::from([[1., 0.], [1., 0.]]));
        ...
        fn basic_cocircular() {
            let r =
                smallest_enclosing_circle(&Vec::from([[1., 0.], [0., 1.], [-1., 0.], [0., -1.]]));
    ...
    mod recursive {
        ...
        #[test]
        fn basic_collinear() {
            let r = smallest_enclosing_circle_recursive(&Vec::from([[0., 0.], [1., 0.], [2., 0.]]));
            assert_eq!(r, Circle::Two([2., 0.], [0., 0.]));
            assert_eq!(r.center(), Some([1., 0.]));
            assert_eq!(r.radius(), 1.);
        }
        ...
        #[test]
        fn basic_duplicate() {
            let r = smallest_enclosing_circle_recursive(&Vec::from([[0., 0.], [1., 0.], [1., 0.]]));
            assert_eq!(r, Circle::Two([1., 0.], [0., 0.]));
            assert_eq!(r.center(), Some([0.5, 0.]));
            assert_eq!(r.radius(), 0.5);
        }
        ...
        #[test]
        fn basic_duplicate2() {
            let r = smallest_enclosing_circle_recursive(&Vec::from([[1., 0.], [0., 0.], [1., 0.]]));
            assert_eq!(r, Circle::Two([0., 0.], [1., 0.]));
            assert_eq!(r.center(), Some([0.5, 0.]));
            assert_eq!(r.radius(), 0.5);
        }
        ...
        #[test]
        fn basic_single() {
            let r = smallest_enclosing_circle_recursive(&Vec::from([[0., 0.]]));
            assert_eq!(r, Circle::One([0., 0.]));
            assert_eq!(r.center(), Some([0., 0.]));
            assert_eq!(r.radius(), 0.);
        }
        ...
        #[test]
        fn basic_double() {
            let r = smallest_enclosing_circle_recursive(&Vec::from([[0., 0.], [1., 0.]]));
            assert_eq!(r, Circle::Two([1.0, 0.], [0., 0.]));
            assert_eq!(r.center(), Some([0.5, 0.]));
            assert_eq!(r.radius(), 0.5);
        }
        ...
        #[test]
        fn basic_double_duplicate() {
            let r = smallest_enclosing_circle_recursive(&Vec::from([[1., 0.], [1., 0.]]));
            assert_eq!(r, Circle::One([1.0, 0.]));
            assert_eq!(r.center(), Some([1., 0.]));
            assert_eq!(r.radius(), 0.);
        }
